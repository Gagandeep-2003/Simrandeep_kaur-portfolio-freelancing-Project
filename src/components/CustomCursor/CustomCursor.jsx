...
const CustomCursor = () => {
  ...
  useEffect(() => {
    ...
    const addCursorEffects = () => {
      ...
      const buttons = document.querySelectorAll('button, .app__footer-card, .app__work-item, .app__skills-item, .app__about-profile');
      ...
      const links = document.querySelectorAll('a, .app__navbar-links li');
      links.forEach(link => {
